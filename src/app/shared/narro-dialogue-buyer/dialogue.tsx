    ...
    <div className='w-full'>
      ...
      <div
        ...
        >
            ...
            <div className="flex flex-col md:flex-row min-h-[550px] h-[620px] w-full gap-5">
              <div className={`flex-1 flex flex-col transition-all duration-500 ease-in-out ${isFullScreen ? 'md:w-3/5' : 'md:w-3/5'}`}>
              ...
              <div className={`flex flex-col transition-all duration-500 ease-in-out ${isFullScreen ? 'flex' : 'hidden'} md:flex`} style={{
              ...(isFullScreen ? {
                display: 'flex',
              } : { display: 'none', }),
              }}>
