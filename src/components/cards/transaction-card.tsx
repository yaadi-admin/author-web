    ...
    >
      <div className="mb-4 flex items-center gap-5">
        ...
        <div className="space-y-2">
          ...
          {/* <p className="text-2xl font-medium text-gray-900 @[19rem]:text-3xl font-primary"> */}
          <p className="font-primary text-lg font-semibold text-gray-900 2xl:text-[20px] 3xl:text-[22px] dark:text-gray-700">
            {amount}
          </p>
        </div>
      </div>
...
export function SupportRangeCard({
  className,
  transaction,
}: SupportTypeProps) {
  const {
  ...
  return (
    <div
      className={cn(
        'w-full rounded-[10px] border-gray-300 px-6 py-7 @container',
        className
      )}
    >
      <div className="mb-4 flex items-center gap-5">
        ...
        <div className="space-y-2">
          <p className="text-gray-500 ">{title}</p>
          <Button color='secondary' className="w-full gap-3 @lg:w-auto" variant={"solid"}>
            {amount}
          </Button>
        </div>
      </div>
