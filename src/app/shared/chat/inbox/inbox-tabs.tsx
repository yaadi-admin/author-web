...
export default function ChatInboxTabs({ className, selectedChannel, setSelectedChannel }: { className?: string; selectedChannel?: string; setSelectedChannel?: any }) {
  return <ChatDetails selectedChannel={selectedChannel} setSelectedChannel={setSelectedChannel} className={cn(className)} />;
}
