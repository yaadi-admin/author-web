    ...
    <>
      ...
      <FormProvider {...methods}>
        <form className="pb-8 pt-5" onSubmit={methods.handleSubmit(onSubmit)}>
          <div className="mb-1.5 mt-2 flex items-end font-primary text-base">
          ...
          <div className="mb-3.5 flex items-start justify-between pt-6">
            <Title as="h6" className="font-secondary text-sm font-medium">
              Select Size
            </Title>
          ...
          <Title as="h6" className="mb-3.5 mt-6 font-secondary text-sm font-medium">
            Select Color
          </Title>
