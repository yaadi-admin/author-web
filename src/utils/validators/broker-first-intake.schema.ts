...
export const brokerSchema = z.object({
  ...
  companyLegalName: z.string().min(1, { message: 'Company Legal name is required' }),
  ...
  Proposition1: z.string().min(1, { message: 'Unique Proposition is required'}),
  Proposition2: z.string().min(1, { message: 'Unique Proposition is required'}),
  Proposition3: z.string().min(1, { message: 'Unique Proposition is required'}),
