            ...
            >
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                    ...
                    <Button
                        ...
                        onClick={() => push(routes.seller.investorDueDiligence(data.investor.data.id))}
                        onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#005A9E'}
                        onMouseOut={(e) => e.currentTarget.style.backgroundColor = '#0078D4'}
                        className='w-full h-10 text-md font-normal text-white bg-primary-color hover:bg-black'
                    >
                        {/* <FilesIcon style={{ marginRight: '0.59rem', width: '18px', height: '18px' }} /> */}
                       Start Due Diligence
                    </Button>
                </div>
            </div>
