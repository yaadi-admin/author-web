    ...
    <div className='w-full'>
      ...
      <div
        ...
        <form
          ...
          className='col-span-full w-full h-screen mt-10'
          style={{
        ...
        >
            ...
            <div className="col-span-full flex items-center justify-center my-auto h-full px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row min-h-[550px] h-[620px] w-full sm:w-[90%] md:w-[80%] gap-5">
              <div
              className={`flex-1 flex flex-col  transition-all duration-500 ease-in-out ${
                isFullScreen ? 'w-full md:w-1/2' : 'w-full'
              }`}
              >
