      ...
      <section className="relative min-h-[40vh] sm:min-h-[50vh] md:min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="font-league-spartan text-lg sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-normal text-white sm:ml-[-20%] md:ml-[-40%] lg:ml-[-60%] sm:mt-[-2%] md:mt-[-4%] lg:mt-[-6%] mt-2">
              Suzanna Griffiths
            </h2>
          </div>
        </div>
            ...
            <div className="bg-white/50 rounded-lg p-4 sm:p-6 md:p-8 backdrop-blur-sm">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                    <button className="bg-white text-black px-4 sm:px-6 py-2 sm:py-3 rounded border border-black hover:bg-gray-100 transition-colors font-inter text-xs sm:text-sm">
                      BUY NOW
                    </button>
                  </div>
                </div>
