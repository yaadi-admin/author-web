...
function CallTitle(props: CallTitleProps) {
  ...
  return (
    <div className="bg-primary flex items-center rounded-tl-lg rounded-tr-lg"
      style={{
      ...
      {info &&
        <Tooltip title="" body={info}>
          <Button variant="text" className=''>
            <GrCircleInformation className="text-3xl text-white font-bold" />
          </Button>
        </Tooltip>
      }
      ...
      <div className='ml-auto'>
        {!isChatShown &&
          <Button variant='text' onClick={onToggle}>
            <LuMessageCircle className='mr-2 h-6 w-6 text-white' />
            <p className='text-white text-md font-semibold'>Show</p>
          </Button>
        }
      </div>
    </div>
