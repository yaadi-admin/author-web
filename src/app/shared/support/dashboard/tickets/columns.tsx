...
export const getColumns = ({
  ...
  onHeaderCellClick,
    ...
    },
    {
      ...
      key: 'message',
      width: 500,
      render: (message: string) => <p className="line-clamp-1">{message}</p>,
    },
    {
      title: (
        <HeaderCell
      ...
      key: 'user',
      width: 400,
      render: ({ firstName, lastName, profilePictureURL }: { firstName: string, lastName: string, profilePictureURL: string }) => (
        <AvatarCard src={profilePictureURL} name={`${firstName} ${lastName}`} />
      ),
    },
    // {
    //   title: (
    ...
    // },
    {
      ...
      key: 'createdAt',
      width: 250,
      // render: (createdAt: string) => <p className="line-clamp-1">{createdAt.toString()}</p>,
      render: (value: { seconds: number }) => {
        const nextDate = new Date(value.seconds * 1000);
        return <DateCell date={nextDate} />
      },
    },
    // {
    //   title: (
