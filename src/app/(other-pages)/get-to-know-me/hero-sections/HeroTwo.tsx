        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          <div>
            ...
            <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-black tracking-wide">
              <span className="font-medium">Discover</span> our featured
              <span className="text-green-800/95 font-medium"> services</span>
            </h2>
          ...
          <div className="mt-6 md:mt-0">
            <button 
              ...
              className="group relative overflow-hidden bg-black hover:bg-green-800/95 text-white font-medium rounded-full px-6 py-3 transition-all duration-300 shadow-md hover:shadow-lg"
            >
