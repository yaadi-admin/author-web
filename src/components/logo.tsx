...
export default function Logo({ iconOnly = false, companyName, ...props }: IconProps) {
  if (companyName && ['rumin8-testing'].includes(companyName)) {
    return (
      <Image
        src={"https://firebasestorage.googleapis.com/v0/b/yaadi-ltd.appspot.com/o/logo-short.png?alt=media&token=947d7460-bf2d-41b0-9dc6-4107b94ca94a"}
        alt="Logo"
        width={500}
        height={500}
