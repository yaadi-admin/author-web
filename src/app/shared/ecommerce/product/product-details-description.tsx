  ...
  return (
    <Collapse
      ...
      header={({ open, toggle }) => (
        <div
          role="button"
          onClick={toggle}
          className="flex w-full cursor-pointer items-center justify-between py-6 font-primary text-lg font-semibold text-gray-900"
        >
          Product Details
    ...
    >
      <div className="-mt-2 pb-7">
        ...
        <Title as="h6" className="mt-6 font-secondary text-sm font-semibold">
          Material & Care
        </Title>
