...
export default function SignUp() {
  return (
    <AuthWrapperOne
      ...
      bannerTitle="The simplest way to buy or sell your business."
      bannerDescription="Narro reduces the friction, increases the speed, and elevates the experience of selling and buying small-to-medium businesses."
