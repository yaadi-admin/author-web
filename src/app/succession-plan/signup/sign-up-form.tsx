...
import { successionSignUpSchema, SuccessionSignUpSchema } from '@/utils/validators/signup.schema';
...
export default function SignUpForm() {
  ...
  const onSubmit: SubmitHandler<SuccessionSignUpSchema> = (data) => {
  ...
  return (
    <>
      ...
      {!waitingList && <Form<SuccessionSignUpSchema>
        validationSchema={successionSignUpSchema}
        resetValues={reset}
        onSubmit={onSubmit}
        useFormProps={{
