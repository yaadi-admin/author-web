...
export default function SlideOutNav({ whiteText = false }: SlideOutNavProps) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full max-w-[15%] z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="relative flex flex-col h-full p-8">
          ...
          <div className="flex gap-4 justify-center pt-8 border-t border-white/20">
            <a href="#" className="text-white hover:text-suelyn-pink transition-colors">
