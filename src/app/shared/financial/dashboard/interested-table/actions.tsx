        ...
        <>
            <div className="flex items-center justify-end gap-3 pe-3">
                        ...
                        {({ setOpen }) => (
                            <div className="w-56 pb-2 pt-1 text-left rtl:text-right">
                                ...
                                <Text className="mb-2 leading-relaxed text-gray-500">
                                    Sharing due diligence with {row.investor.data.firstName}{' '}
                                    {row.investor.data.lastName} will grant access to the business’s files and reports. This action cannot be undone.
                                </Text>
                ...
                {isInterestedDisabled && (
                    <Tooltip size="sm" content="View Investor Files" placement="top" color="invert">
                        <ActionIcon
                            as="span"
                            size="sm"
                            variant="outline"
                            aria-label="View Investor Files"
                            className="hover:!border-gray-900 hover:text-gray-700"
                            onClick={() =>
                                push(routes.seller.investorDueDiligence(row.investor.data.id))
                            }
                        >
