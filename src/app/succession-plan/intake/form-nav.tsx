...
export const menuItems = [
  {
    label: 'About You',
    value: formParts['about-you'],
  },
  {
    label: 'About You (Part 2) ',
    value: formParts['about-you-v2'],
  },
  {
    label: 'Company Profile',
    value: formParts.companyProfile,
  },
  {
    label: 'Advisory Team',
    value: formParts['advisory-team'],
  },
];
...
export default function FormNav({ className }: FormNavProps) {
  return (
    <div
      className={cn(
        ' z-20 border-b border-gray-300  bg-white py-0 font-medium text-gray-500 @2xl:top-[72px] 2xl:top-20 dark:bg-gray-50',
        className
      )}
    >
      <SimpleBar>
