      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          {/* <nav className="hidden md:flex items-center gap-8">
            <Link to="/about" className="font-inter text-lg font-bold text-black hover:text-suelyn-pink transition-colors">
              About
            </Link>
            <Link to="/author" className="font-inter text-lg font-bold text-black hover:text-suelyn-pink transition-colors">
              Author
            </Link>
            <Link to="/blog" className="font-inter text-lg font-bold text-black hover:text-suelyn-pink transition-colors">
              Blog
            </Link>
            <Link to="/workshops" className="font-inter text-lg text-black hover:text-suelyn-pink transition-colors">
              Workshops
            </Link>
          </nav> */}

          {/* Right side - Dark mode toggle and menu */}
          <div className="flex items-center gap-4">
            <button className="text-black hover:text-suelyn-pink transition-colors">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button className="md:hidden text-black hover:text-suelyn-pink transition-colors">
